...
# This is a custom package that we use in the market risk calculations.
...
class Market:
    ...
    - Need to resolve the day count issue.
      Currently the function uses ACTUAL/ACTUAL.
    ...
    - We make no accurate calcualtion of the dirty market price.
    - In the calcualtion we discount all cashflows at the risk-free rate.
    ...
    def f_market_risk(self):
        ...
        The current process makes used of a nested loop.
        It could be sped up using various vector operations.
        ...
        The main work is going to happen when we start to allocate assets
        ...
        for shock in shock_list:
            ...
            # Shortening the reference that we need to use
            asset_data = self.output["asset_data"]
            ...
            if shock in (
                ...
                # This has to be input manually, we don't ahve an automated calculation
    ...
    def f_data(self, data: str = "", sub_data: str = "") -> Union[pd.DataFrame, None]:
        ...
        try:
            ...
            #logger.critical(f"Error: {data} - {sub_data} - {e}")
